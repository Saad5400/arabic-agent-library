...
- 39 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 33 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 45 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
6. ثم أضيفت توسعة نحوية/أسلوبية كبيرة داخل `الكتاب` من `الجزء الرابع` الكامل على ويكي مصدر: raw جديد، text عملي، وثلاث حزم Markdown تغطي الابتداء و`إنّ` و`كم`، والنداء والندبة، والنفي والاستثناء والضمائر؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة نطاقات كبيرة جديدة بهذا الحجم لا إعادة تلميع الحزم الحالية بلا حاجة.
