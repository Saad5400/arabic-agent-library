...
- 17 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 20 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 25 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
الأولوية الآن بعد اكتمال أول دفعة بلاغية واسعة من `دلائل الإعجاز` ليست الإكثار من العناوين، بل متابعة طبقة البلاغة على المصدر التالي في الخطة (`أسرار البلاغة`) مع الحفاظ على قاعدة الدفعات الخام الكبيرة والحزم المتوسطة الغنى.
