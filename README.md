...
- 34 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 29 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 44 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
5. بعد الإغلاق المرحلي أضيفت توسعة معجمية كبيرة جديدة داخل `تاج العروس` من الأوراق 413-455، فصارت تغطيته العملية المسجلة نحو 86 ورقة وأربع حزم Markdown؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة مصادر أو نطاقات جديدة كبيرة ومصدرية لا إعادة تلميع الحزم الحالية بلا حاجة.
