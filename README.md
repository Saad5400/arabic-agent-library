...
- 44 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 36 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
...
5. بعد الإغلاق المرحلي أضيفت توسعتان معجميتان كبيرتان داخل `تاج العروس`: الأوراق 413-455 ثم الأوراق 456-498 من شاهد DjVuXML نفسه، فصارت تغطيته العملية المسجلة نحو 129 ورقة وست حزم Markdown.
...
8. وفي هذه الدفعة أضيفت توسعة مرجعية كبيرة داخل `كتاب الصناعتين`: حُفظا DjVuXML وscandata الخامان، واستُخرجت الأوراق/OBJECTs 120-179 (نحو 60 ورقة) عن حسن السبك، والإيجاز/الإطناب، والأخذ من السابقين، مع OCR وسيط وtext عملي وثلاث حزم Markdown متناسبة مع قاعدة ~ملف لكل 20 صفحة؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة نطاق كبير جديد لا تلميع الحزم الحالية بلا حاجة.
