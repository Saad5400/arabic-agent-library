...
- 32 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 26 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
...
5. الأولوية اللاحقة، إن استؤنف البناء، هي إضافة مصادر أو نطاقات جديدة كبيرة ومصدرية لا إعادة تلميع الحزم الحالية بلا حاجة.
