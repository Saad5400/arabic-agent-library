...
- 37 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 30 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
...
5. بعد الإغلاق المرحلي أضيفت توسعة معجمية كبيرة جديدة داخل `تاج العروس` من الأوراق 413-455، فصارت تغطيته العملية المسجلة نحو 86 ورقة وأربع حزم Markdown.
