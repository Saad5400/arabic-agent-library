...
- 22 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 21 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 29 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
الأولوية الآن بعد اكتمال طبقة البلاغة في مصدريها (`دلائل الإعجاز` و`أسرار البلاغة`) ليست العودة إلى توسعات صغيرة متكررة، بل الانتقال وفق الخطة إلى طبقة الشعر على المصدر التالي (`ديوان أبي تمام`) مع الحفاظ على قاعدة الدفعات الخام الكبيرة والحزم المتوسطة الغنى.
