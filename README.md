...
- 41 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 34 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 46 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
7. وبعدها أضيفت توسعة نحوية/أسلوبية كبيرة داخل `الخصائص` من 12 صفحة ويكي مصدرية عن اختلاف اللغات، والسماع والقياس، وتركب اللغات وتلاقيها: raw حجمه 136,667 bytes، وtext عملي، وحزمتا Markdown؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة نطاقات كبيرة جديدة بهذا الحجم لا إعادة تلميع الحزم الحالية بلا حاجة.
