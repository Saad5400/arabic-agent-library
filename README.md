...
- 46 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 39 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 48 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
9. وفي هذه الدفعة أضيفت توسعة معجمية رابعة داخل `تاج العروس`: استُخرجت الأوراق/OBJECTs 499-541 (نحو 43 ورقة) حتى آخر الشاهد، مع OCR وسيط وtext عملي ونص جامع للأوراق 370-541 وحزمتين Markdown عن الجسد والجعد والجلد والجمد، وعن الجند والجود والجهد والجيد؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة نطاق كبير من مصدر آخر أو طبقة غير مستهلكة حديثًا لا تلميع الحزم الحالية بلا حاجة.
