...
- 14 مصدرًا مسجّلًا في السجل المركزي.
- 50 حزمة ماركداون مصدرية موجَّهة للوكيل (دون احتساب ملف القالب `_template.md`).
- 41 ملفًا نصيًّا منظفًا أو عمليًّا تحت `data/text/`.
- 49 ملفًا خامًّا أو أثر اقتناء محفوظًا تحت `data/raw/` (دون احتساب `.gitkeep`).
...
10. وفي هذه الدفعة أضيفت توسعة مرجعية كبيرة داخل `أدب الكاتب`: حُفظ raw بنيوي جديد `data/raw/reference-adab-al-katib.ia-djvu.xml`، واستُخرجت OBJECTs/leaves 65-140 (نحو 76 ورقة) من تتمة `كتاب المعرفة` وبداية `أبواب الفروق`، مع OCR وسيط وtext عملي وأربع حزم Markdown جديدة عن الأسماء والطبيعة، والحيوان والخيل، وعيوب الإنسان، والفروق في الإنسان والحيوان والطعام؛ والأولوية اللاحقة، إن استؤنف البناء، هي إضافة نطاق كبير من مصدر أو طبقة غير مستهلكة حديثًا لا تلميع الحزم الحالية بلا حاجة.
